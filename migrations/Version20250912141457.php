...
final class Version20250912141457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE burger (id INT AUTO_INCREMENT NOT NULL, pain_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_EFE35A0D64775A84 (pain_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE burger_image (burger_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_E74C553C17CE5090 (burger_id), INDEX IDX_E74C553C3DA5256D (image_id), PRIMARY KEY(burger_id, image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE burger_image ADD CONSTRAINT FK_E74C553C17CE5090 FOREIGN KEY (burger_id) REFERENCES burger (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE burger_image ADD CONSTRAINT FK_E74C553C3DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE CASCADE');
